...
//!
//! ```rust,ignore
//! use astro_core::coordinates::rotations::{rotation_x, rotation_y, rotation_z};
...
///
/// ```rust,ignore
/// use astro_core::coordinates::rotations::rotation_x;
/// use std::f64::consts::PI;
///
...
///
/// ```rust,ignore
/// use astro_core::coordinates::rotations::rotation_y;
/// use std::f64::consts::PI;
///
...
///
/// ```rust,ignore
/// use astro_core::coordinates::rotations::rotation_z;
/// use std::f64::consts::PI;
///
...
///
/// ```rust,ignore
/// use astro_core::coordinates::rotations::{rotation_z, is_rotation_matrix};
/// use std::f64::consts::PI;
///
...
///
/// ```rust,ignore
/// use astro_core::coordinates::rotations::{rotation_z, rotation_angle};
/// use std::f64::consts::PI;
///
...
///
/// ```rust,ignore
/// use astro_core::coordinates::rotations::{rotation_x, rotation_axis};
/// use nalgebra::Vector3;
/// use std::f64::consts::PI;
///
...
///
/// ```rust,ignore
/// use astro_core::coordinates::rotations::euler_313;
/// use std::f64::consts::PI;
///
...
///
/// ```rust,ignore
/// use astro_core::coordinates::rotations::euler_321;
/// use std::f64::consts::PI;
///
