...
//!
//! ```rust,ignore
//! use astro_core::coordinates::frames::{GCRS, ITRS};
//! use astro_core::coordinates::transform::CoordinateFrame;
...
///
/// ```rust,ignore
/// use astro_core::coordinates::transform::{transform, FrameType};
