...
/// use astro_core::coordinates::frames::ICRS;
///
...
/// ```rust,ignore
/// use nalgebra::Vector3;
/// use astro_core::coordinates::frames::GCRS;
...
impl GCRS {
    ...
    pub fn to_itrs(&self) -> PoliastroResult<ITRS> {
        ...
        let omega_earth = 7.2921150e-5; // rad/s (IERS)
...
/// ```rust,ignore
/// use nalgebra::Vector3;
/// use astro_core::coordinates::frames::ITRS;
/// use astro_core::core::time::Epoch;
///
...
/// ```rust,ignore
/// use nalgebra::Vector3;
/// use astro_core::coordinates::frames::TEME;
/// use astro_core::core::time::Epoch;
///
...
impl TEME {
    ...
    /// Convert to GCRS frame (via ITRS)
    pub fn to_gcrs(&self) -> PoliastroResult<GCRS> {
...
/// # Examples
/// ```rust,ignore
/// use astro_core::coordinates::frames::Perifocal;
/// use nalgebra::Vector3;
///
...
/// # Examples
/// ```rust,ignore
/// use astro_core::coordinates::frames::J2000;
/// use nalgebra::Vector3;
///
