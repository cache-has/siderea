...
//!
//! ```ignore
//! use astro_core::propagators::perturbations_static::j2_perturbation_static;
//! use astro_core::core::integrators_static::{StateVector6, position, velocity};
//!
...
///
/// ```ignore
/// use astro_core::propagators::perturbations_static::j2_dynamics;
/// use astro_core::core::integrators_static::{StateVector6, propagate_rk4_final_only};
///
