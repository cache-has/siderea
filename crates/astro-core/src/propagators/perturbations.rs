...
/// # Example
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::j2_perturbation;
/// use astro_core::core::constants::{GM_EARTH, J2_EARTH, R_EARTH};
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::exponential_density;
/// use astro_core::core::constants::{RHO0_EARTH, H0_EARTH, R_EARTH};
///
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::drag_acceleration;
/// use astro_core::core::constants::{R_EARTH, RHO0_EARTH, H0_EARTH};
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::j2_acceleration_func;
/// use astro_core::core::constants::{GM_EARTH, J2_EARTH, R_EARTH};
///
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::propagate_j2_rk4;
/// use astro_core::core::constants::{GM_EARTH, J2_EARTH, R_EARTH};
///
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::propagate_j2_dopri5;
/// use astro_core::core::constants::{GM_EARTH, J2_EARTH, R_EARTH};
///
/// let r0 = Vector3::new(7000e3, 0.0, 0.0);
/// let v0 = Vector3::new(0.0, 7546.0, 0.0);
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::propagate_j2_dop853;
/// use astro_core::core::constants::{GM_EARTH, J2_EARTH, R_EARTH};
///
/// let r0 = Vector3::new(7000e3, 0.0, 0.0);
/// let v0 = Vector3::new(0.0, 7546.0, 0.0);
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::propagate_drag_rk4;
/// use astro_core::core::constants::{GM_EARTH, R_EARTH, RHO0_EARTH, H0_EARTH};
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::sun_position_simple;
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::moon_position_simple;
///
/// let t = 0.0; // J2000 epoch
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::{third_body_perturbation, sun_position_simple};
/// use astro_core::core::constants::GM_SUN;
///
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::sun_moon_perturbation;
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::{third_body_acceleration_func, sun_position_simple};
/// use astro_core::core::constants::{GM_EARTH, GM_SUN};
///
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::propagate_thirdbody_rk4;
/// use astro_core::core::constants::GM_EARTH;
///
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::{shadow_function, sun_position_simple};
/// use astro_core::core::constants::R_EARTH;
///
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::{srp_acceleration, sun_position_simple};
/// use astro_core::core::constants::R_EARTH;
///
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::propagate_srp_rk4;
/// use astro_core::core::constants::{GM_EARTH, R_EARTH};
///
/// // CubeSat in GEO
...
/// ```ignore
/// use astro_core::core::linalg::Vector3;
/// use astro_core::propagators::perturbations::{propagate_cowell, j2_perturbation};
/// use astro_core::core::constants::{GM_EARTH, J2_EARTH, R_EARTH};
///
/// let r0 = Vector3::new(7000e3, 0.0, 0.0);
/// let v0 = Vector3::new(0.0, 7546.0, 0.0);
...
///
/// ```ignore
/// use astro_core::propagators::perturbations::{Perturbation, J2Perturbation, DragPerturbation};
/// use astro_core::core::constants::{GM_EARTH, J2_EARTH, R_EARTH};
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::J2Perturbation;
/// use astro_core::core::constants::{J2_EARTH, R_EARTH};
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::DragPerturbation;
/// use astro_core::core::constants::{R_EARTH, RHO0_EARTH, H0_EARTH};
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::ThirdBodyPerturbation;
/// use astro_core::core::constants::{GM_SUN, GM_MOON};
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::SolarRadiationPressure;
/// use astro_core::core::constants::R_EARTH;
///
...
/// # Example
/// ```ignore
/// use astro_core::propagators::perturbations::{
