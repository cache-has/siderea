...
/// # Example
/// ```
/// use astro_core::core::elements::rv_to_coe;
...
/// # Example
/// ```
/// use astro_core::core::elements::{OrbitalElements, coe_to_rv};
/// use astro_core::core::constants::GM_EARTH;
///
...
/// # Example
/// ```
/// use astro_core::core::elements::{OrbitalElements, coe_to_equinoctial};
///
/// let elements = OrbitalElements::new(
///     7000e3,    // a: 7000 km
///     0.01,      // e: slight eccentricity
...
/// # Example
/// ```
/// use astro_core::core::elements::{EquinoctialElements, equinoctial_to_coe};
///
...
/// # Example
/// ```
/// use astro_core::core::elements::rv_to_equinoctial;
/// use astro_core::core::linalg::Vector3;
/// use astro_core::core::constants::GM_EARTH;
///
/// let r = Vector3::new(7000e3, 0.0, 0.0);
...
/// # Example
/// ```
/// use astro_core::core::elements::{EquinoctialElements, equinoctial_to_rv};
/// use astro_core::core::constants::GM_EARTH;
///
/// let eq_elements = EquinoctialElements::new(
